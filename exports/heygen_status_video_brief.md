...
The externally verified integrations are: github, airtable, data-analytics, notion, heygen, slack, vercel, actively, close.

The locally prepared integrations awaiting external proof are: none.

The remaining integrations still needing stronger external evidence are: circleback.
