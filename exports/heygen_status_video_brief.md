...
The externally verified integrations are: airtable, data-analytics, notion, heygen, slack, vercel.

The locally prepared integrations awaiting external proof are: github.

The remaining integrations still needing stronger external evidence are: github, circleback, actively, close.
